...
import_peaks <- function(consensus_file_path = "scratch/Shares/rinnclass/data/peaks") {
  ...
  sample_name <- str_extract(file_names, "^[^_]+(?=_)")
...
plot_profile <- function(tag_count, sample_name) {
